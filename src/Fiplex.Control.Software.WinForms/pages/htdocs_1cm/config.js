...
function Config(maxChNr) {
	...
	this.computeChNum = function(fr, isUL) {
		...
		if (!isUL)
			num = (fr - factory.data.band[1].fo) / factory.data.fstep;
		else
			num = (fr - factory.data.band[0].fo) / factory.data.fstep;
