...
(function() {
	...
	if (typeof(window.top.TAGLEN) === "undefined")
		window.top.TAGLEN = 15;
	if (typeof(window.top.LOCLEN) === "undefined")
		window.top.LOCLEN = 15;	
	...
	if (typeof(window.top.stateled) === "undefined")
		window.top.stateled = new Array();
	if (typeof(window.top.stateledExp) === "undefined")
		window.top.stateledExp = new Array();	
	...
	if (typeof(window.top.master_dataSyncAlarm) === "undefined")
		window.top.master_dataSyncAlarm = new Array();
	if (typeof(window.top.master_dataLockAlarm) === "undefined")
		window.top.master_dataLockAlarm = new Array();
	if (typeof(window.top.attin) === "undefined")
		window.top.attin = new Array();
	if (typeof(window.top.attout) === "undefined")
		window.top.attout = new Array();
})();
