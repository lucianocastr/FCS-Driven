...
function GuiFact() {
	...
	this.shGainULCorr = function(fact, b) {
		var el = document.getElementById('gainULcorrection'+'_'+b);
		el.value = fact.gainULcorrection[b].toFixed(1);
	}
	...
	this.rdGainULCorr = function(fact, b) {
		var el = document.getElementById('gainULcorrection'+'_'+b);
		fact.gainULcorrection[b] = parseFloat(el.value);
	}
	...
	this.Map = [
		...
		[
			...
			},
			{
				id:'gainULcorrection',
				display: true,
				label:'GAIN&nbsp;UL&nbsp;CORRECTION&nbsp;',
				type: 'input',
				inputtype: 'text',
				onkey: isKeyDecimalNumber,
				show: this.shGainULCorr,
				read: this.rdGainULCorr,
				len: 2
			}
		],
		[	
