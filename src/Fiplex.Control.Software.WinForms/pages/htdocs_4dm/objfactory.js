 function Factory(factoryFrame) {
	...
	this.parse = function(s) {
		...
		for (b=0;b<2;b++){
			...
			this.gainULcorrection[b] =  to_float(parseInt(s.substring(ind,ind+4),16)); ind+=4;
	...
	this.getFrm = function(){
		...
		for (var b=0;b<2;b++){
			...
			cal += hexformat(double_to_uint(this.gainULcorrection[b]),4);
