...
function onloadInit() {
	...
	if (typeof(window.parent.navi.confFrame) !== 'undefined') {
		var ret = config.parse(window.parent.navi.confFrame);
		if (ret==-2){//blocked
			window.parent.navi.document.getElementById("start").click();
			return;
		}
...
function showRefresh() {
	try {
		...
		img.src = "i/bullet_green.png";
		setTimeout(function() {
			document.getElementById("spectRefreshed").src = "/i/blank.gif";
		}, 1000);
