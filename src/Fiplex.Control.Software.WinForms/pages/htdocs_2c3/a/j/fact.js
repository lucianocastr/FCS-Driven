...
function GuiFact() {
	...
	this.shExtPaCorrection = function(fact, b) {
		var el = document.getElementById('extPaCorrection_'+b);
		el.value = fact.extPaCorrection[b].toFixed(1);
	}
	this.rdExtPaCorrection = function(fact, b) {
		var el = document.getElementById('extPaCorrection'+'_'+b);
	...
	this.rdExtPaCorrection = function(fact, b) {
		var el = document.getElementById('extPaCorrection_'+b);
		fact.extPaCorrection[b] = parseFloat(el.value);
	}
	...
	this.Map = [
		...
		[
			...
			},
			{
				id:'extPaCorrection',
				display: true,
				label:'EXTERNAL&nbsp;PA&nbsp;CORRECTION',
				type: 'input',
				inputtype: 'text',
				onkey: isKeyDecimalNumber,
				show: this.shExtPaCorrection,
				read: this.rdExtPaCorrection,
				len: 2
			}
		],
		[	
