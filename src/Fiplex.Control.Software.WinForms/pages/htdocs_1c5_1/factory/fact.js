		...
		xhr.onreadystatechange  = function(ev) {
			if (this.readyState==4) {
				if (this.status === 200) {
					...
					initFormChangeCheck();
					var clk = factory.getOsc();
					window.parent.navi.filter_help_args(clk);
					window.parent.navi.filterTool(clk);
					guiBlocked(false);
					load_status();
				} else {
...
function GuiFact() {
	...
	this.rdFstartAdj = function(fact, b) {
		var el = document.getElementById('fnStart'+'_'+b);
		fact.data.bandAdj[b].fnStart = parseInt(el.value);
	}
	this.rdFstopAdj = function(fact, b) {
		var el = document.getElementById('fnStop'+'_'+b);
		fact.data.bandAdj[b].fnStop = parseInt(el.value);
	}
	this.Titles = [
		'LEVEL&nbsp;ADJUSTMENTS',
		'FREQUENCY&nbsp;ADJUSTMENTS',
		'FIRSTNET&nbsp;ADJUSTMENTS'
	];
	this.Map = [
		[
			{
		...
		[
			...
			},
			{
				id:'powerAdj',
				display:true,
				label:'FIRSTNET&nbsp;POWER&nbsp;CORRECTION&nbsp;',
				type: 'input',
				inputtype: 'text',
				onkey: isKeyDecimalNumber,
			...
			},
			{
				id:'sqThrAdj',
				display:true,
				label:'FIRSTNET&nbsp;SQUELCH&nbsp;THRESHOLD&nbsp;CORRECTION&nbsp;',
				type: 'input',
				inputtype: 'text',
				onkey: isKeyDecimalNumber,
				show: this.shSqThAdj,
			...
			},
			{
				id:'maxGainAdj',
				display:true,
				label:'FIRSTNET&nbsp;MAX&nbsp;GAIN&nbsp;CORRECTION&nbsp;',
				type: 'input',
				inputtype: 'text',
				onkey: isKeyDecimalNumber,
			...
			},
			{
				id:'maxPowAdj',
				display:true,
				label:'FIRSTNET&nbsp;MAX&nbsp;POWER&nbsp;CORRECTION&nbsp;',
				type: 'input',
				inputtype: 'text',
				onkey: isKeyDecimalNumber,
			...
			},
			{
				id:'fnStart',
				display: true,
				label:'FIRSTNET&nbsp;START&nbsp;FREQUENCY&nbsp;',
				type: 'input',
				inputtype: 'text',
				onkey: isKeyDecimalNumber,
				show: this.shFstartAdj,
				read: this.rdFstartAdj,
				len: 2
			},
			{
				id:'fnStop',
				display: true,
				label:'FIRSTNET&nbsp;STOP&nbsp;FREQUENCY&nbsp;',
				type: 'input',
				inputtype: 'text',
				onkey: isKeyDecimalNumber,
				show: this.shFstopAdj,
				read: this.rdFstopAdj,
				len: 2
			}
		]
	];
