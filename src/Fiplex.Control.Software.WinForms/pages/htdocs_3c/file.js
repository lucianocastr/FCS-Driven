...
var saveFileCmd = 
[
	{get: "/global_conf.shtml", post:"nosend" , postReg: "global_req", len: 2840, decode: 0},
...
[
	...
	{get: "/update_nfpa.shtml", post:"nfpa_str" , postReg: "nfpa_req", len:  346, decode: 0},
				...
				if (this.status === 200) {
					if (postget==0){
						...
						if (serverResponse.length!=saveFileCmd[num].len){
							...
							alert("NUM="+num+", len="+serverResponse.length);
							return;
						}
						if (num == 0) {
