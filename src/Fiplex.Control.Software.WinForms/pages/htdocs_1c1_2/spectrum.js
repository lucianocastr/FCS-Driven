...
function Spectrum(maxChNr) {
	...
	this.createBandLimitsForm = function() {
		...
		var fstartspec = localStorage.getItem("start_spec"+window.location.host);
		var fstopspec = localStorage.getItem("stop_spec"+window.location.host);
		if (fstartspec==null)
		...
		localStorage.setItem("start_spec"+window.location.host,this.FreqMinHz);
		localStorage.setItem("stop_spec"+window.location.host,this.FreqMaxHz);
	};
	...
	this.reSetBandLimits = function(ev) {
		...
		localStorage.setItem("start_spec"+window.location.host,this.newFreqMinHz);
		localStorage.setItem("stop_spec"+window.location.host,this.newFreqMaxHz);
		var el = document.getElementById("fstart");
