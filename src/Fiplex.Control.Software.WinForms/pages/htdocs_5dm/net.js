...
function submitform(ndev, isReset, isolVerif, isolClear, clearErrors, delayMeas, forceSend, forcePaOn, forcePaOff) { //ndev indica a qué equipo se refieren el resto de argumentos
	...
	var frmcnf = page.readTotalConfsFrm(ndev, doReset, doIsolVerif, doIsolClear, doClearErrors, doDelayMeas, doForceSend, doForcePaOn, doForcePaOff);
	if (frmcnf.length == 0) {
		waitACK = false;
