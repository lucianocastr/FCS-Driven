...
function hidePass(isPc) {
	...
	row = document.getElementById("communityRow");
	row.style.display = isPc ? "none" : "table-row";
	el.style.display = isPc ? "none" : "inline";
}
...
function VersionT() {
	...
	this.store = function(sr) {
		localStorage.setItem("1A2_versionFrame_"+window.location.host, sr);
	}
	this.retrieve = function() {
		return localStorage.getItem("1A2_versionFrame_"+window.location.host);
	}
