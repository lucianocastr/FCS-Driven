...
function Monitor(maxChNr) {
	...
	this.render = function() {
		...
		if (factory.data.scaTestNFPA){
			rfChInPowSet(11, 1, this.stat.band[1].ch[10].level);
			rfChInPowSet(12, 1, this.stat.band[1].ch[11].level);
		}		
		...
		highTempAlarmSet(this.stat.hTempAlarm ? "red" : "grey");
	}
}
// -->
