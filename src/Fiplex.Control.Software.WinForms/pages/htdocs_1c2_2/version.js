...
function Version() {
	...
	this.store = function(sr) {
		localStorage.setItem("1C3_versionFrame_"+window.location.host, sr);
	}
	this.retrieve = function() {
		return localStorage.getItem("1C3_versionFrame_"+window.location.host);
	}
	...
	this.isFwSimplex = function() {
		if (typeof(this.fwMsb) != 'undefined' && !isNaN(this.fwMsb)) {
			if (this.fwMsb & this.fwBits.SIMPLEX) {
				return true;
			}
		}
		return false;
