 function Factory(factoryFrame) {
	...
	this.parse = function(s) {
		...
		for (b=0;b<2;b++){
			...
			for (i=0;i<2;i++){
				...
				ind+=2;//se bypasa byte sin uso por la eliminación rfoutOffset
			}
	...
	this.getFrm = function(){
		...
		if (this.extremeTempActionEnable) mask |= 0x40;
		if (this.commomUl) mask |= 0x80;
		...
		for (var b=0;b<2;b++){
			...
			for (i=0;i<2;i++){
				...
				cal+=hexformat(mask,2);	
				cal+="00";	//byte sin uso por la eliminación rfoutOffset
			} 
