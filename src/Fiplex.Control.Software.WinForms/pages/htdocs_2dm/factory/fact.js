...
function GuiFact() {
	...
	this.shCommomUlEn = function(fact, b) {
		var el = document.getElementById('commomUlEn'+'_'+b);
		el.checked = fact.commomUl;
	}
	...
	this.rdCommomUlEn = function(fact, b) {
		var el = document.getElementById('commomUlEn'+'_'+b);
		fact.commomUl = el.checked;
	}
	...
	this.Map = [
		[
			...
			},
			{
				...
				type: 'input',
				inputtype: 'checkbox',
				show: this.shCommomUlEn,
				read: this.rdCommomUlEn,
				len: 1
			},
			{
