...
function Spectrum() {
	...
	this.computeOutput = function(rawData) {
		for (var i = 0; i < rawData.length; ++i) {
			rawData[i] += this.OUT_LEVEL_OFFSET[this.chain];
		}
	...
	this.MAXRES = factory.commomUl ? 5:6; //RBWmax de 100KHz en V/U
	this.MAXAVG = 32;
	this.IN_LEVEL_OFFSET = 10;
	this.OUT_LEVEL_OFFSET = [0,30];
	this.settingsBits = {
		io: 	0x01,
		// fstep: 	0x06,
		// fstepS:	1,
