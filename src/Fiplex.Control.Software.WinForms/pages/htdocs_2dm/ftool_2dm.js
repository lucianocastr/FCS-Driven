function ftoolGui() {
	...
	this.initialize = function() {
		...
		this.BWKHZ = this.factory.commomUl ? 150:100;
		this.bwIndex = this.factory.commomUl ? 0:1;
		this.type = this.factory.commomUl ? 1:0;
	...
	this.computeNrFiltBw3dB = function(bw, band) {
		...
		for (var i = 8; i < self.filterTypes[self.type][band].length; ++i) {
			fgr.push(self.filterTypes[self.type][band][i]['data'][1]*1e3);
		}
