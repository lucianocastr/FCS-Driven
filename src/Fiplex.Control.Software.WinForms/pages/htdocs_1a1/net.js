...
function onloadInit() {
	...
	if (!firstLoad && 
		...
		window.top.fiplexTagsStr = localStorage.getItem("tags_1a1");
		window.top.fiplexFactStr = localStorage.getItem("factory_1a1");
		window.top.fiplexConfStr = localStorage.getItem("config_1a1");
		window.top.fiplexMsysStr = localStorage.getItem("modsys_1a1");
	...
	try {
		...
		xhr.onreadystatechange  = function(ev) {
			if (this.readyState == 4 && this.status == 200) {
				...
				localStorage.setItem("modsys_1a1", window.top.fiplexMsysStr);
				modsys.read(window.top.fiplexMsysStr);
				factReq();
			}
		}
	...
	try {
		...
		xhr.onreadystatechange  = function(ev) {
			if (this.readyState == 4 && this.status == 200) {
				...
				localStorage.setItem("factory_1a1", window.top.fiplexFactStr);
				factory.parse(window.top.fiplexFactStr);
				tagsReq();
			}
		}
	...
	try {
		...
		xhr.onreadystatechange  = function(ev) {
			if (this.readyState == 4 && this.status == 200) {
				...
				localStorage.setItem("tags_1a1", window.top.fiplexTagsStr);
				tags.parse(window.top.fiplexTagsStr);
				confReq();
			}
		}
	...
	try {
		...
		xhr.onreadystatechange  = function(ev) {
			if (this.readyState==4 && this.status == 200) {
				...
				localStorage.setItem("config_1a1", window.top.fiplexConfStr);
				config.parse(window.top.fiplexConfStr);
