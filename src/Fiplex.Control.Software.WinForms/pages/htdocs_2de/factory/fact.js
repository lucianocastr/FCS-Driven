...
function GuiFact() {
	...
	this.showStatus = function(mon) {
		var el = document.getElementById('calBoardCurr_5');
		el.value = mon.boardCurrent.toFixed(0)+'mA';
		var el = document.getElementById('calBoardCurr_4');
		el.value = mon.adBoardCurr.toFixed(0);
