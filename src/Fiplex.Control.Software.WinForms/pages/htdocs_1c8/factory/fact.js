...
function GuiFact() {
	...
	this.shUldl = function(fact, b) {
		var el = document.getElementById('uldl'+'_'+b);
		el.selectedIndex = fact.uldl;
	}
	...
	this.rdUldl = function(fact, b) {
		var el = document.getElementById('uldl'+'_'+b);
		fact.uldl = el.selectedIndex;
	}
	...
	this.shSecondCH = function(fact, b) {
		var el = document.getElementById('secondCH'+'_'+b);
		el.checked = fact.secondCH;
	}
	this.rdSecondCH = function(fact, b) {
		var el = document.getElementById('secondCH'+'_'+b);
		fact.secondCH = el.checked;
	}	
	this.Titles = [
		'GENERAL&nbsp;PARAMETERS',
		'BAND&nbsp;PARAMETERS',
	...
	this.Map = [
		[
			...
			},
			{
				...
				type: 'input',
				inputtype: 'checkbox',
				show: this.shSecondCH,
				read: this.rdSecondCH,
				len: 1
			},
			{
				id:'uldl',
				display: true,
				label:'SCA&nbsp;ACTIVE&nbsp;RF&nbsp;CHAIN',
				type: 'select',
