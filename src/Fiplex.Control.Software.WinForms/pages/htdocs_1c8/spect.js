...
function Spectrum() {
	...
	this.oldversion = version.compareSw(1,9)<0;
	...
	this.MAXRES = factory.fstart[3]>600e6?5:6;
	this.MAXAVG = 32;
	...
	if (this.oldversion){
		this.MAXRES = 4;
		this.settingsBits.rbw = 0x18;
		this.settingsBits.rbwS = 3;
	}
	this.avg;
	this.chain;
	this.band;
