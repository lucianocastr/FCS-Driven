...
function onloadInit() {
	...
	if (!firstLoad && 
		...
		window.top.fiplexTagsStr = localStorage.getItem("tags_1c2"+window.location.host);
		window.top.fiplexFactStr = localStorage.getItem("factory_1c2"+window.location.host);
		window.top.fiplexConfStr = localStorage.getItem("config_1c2"+window.location.host);
	...
	try {
		...
		xhr.onreadystatechange  = function(ev) {
			if (this.readyState == 4 && this.status == 200) {
				...
				localStorage.setItem("factory_1c2"+window.location.host, window.top.fiplexFactStr);
				factory.parse(window.top.fiplexFactStr);
				tagsReq();
			}
		}
	...
	try {
		...
		xhr.onreadystatechange  = function(ev) {
			if (this.readyState == 4 && this.status == 200) {
				...
				localStorage.setItem("tags_1c2"+window.location.host, window.top.fiplexTagsStr);
				tags.parse(window.top.fiplexTagsStr);
				confReq();
			}
		}
	...
	try {
		...
		xhr.onreadystatechange  = function(ev) {
			if (this.readyState==4 && this.status == 200) {
				...
				localStorage.setItem("config_1c2"+window.location.host, window.top.fiplexConfStr);
				config.parse(window.top.fiplexConfStr);
