...
/update	U1{data}	0	1	Update configuration";
    ...
    private async Task<bool> SendProdConfigAsync(DeviceInfo device, short nchannels, short mode, bool clearROM)
    {
        ...
        try
        {
            ...
            // INIT-019 / VB6 1.12 parity (frmMainW.frm:3457-3460): 3c ndev>=1 reads C1 (MMS + BBU byte).
            // FATAL on failure (VB6 GoTo lberror).
            if (tdev == "3c" && ndev >= 1.0)
            {
                ProdLog("[C1] Sending C1 pre-read (3c ndev>=1)...");
                var c1Cmd3c = new SerialCommand
                {
                    Payload = "C1", ExpectsAck = true, ExpectsData = true,
                    AckTimeout = TimeSpan.FromSeconds(2), DataTimeout = TimeSpan.FromSeconds(10),
                    MaxRetries = 1, CancellationToken = _cts?.Token ?? default
                };
                var c1Result3c = await _pipeline.EnqueueCommandAsync(c1Cmd3c);
                ProdLog($"[C1] Result: Success={c1Result3c.Success} DataLen={c1Result3c.Data?.Length ?? 0}");
                if (!c1Result3c.Success || string.IsNullOrEmpty(c1Result3c.Data) || c1Result3c.Data.Length < 1602)
                {
                    ProdLog($"[C1] FAILED (3c) â€” Status={c1Result3c.Status} DataLen={c1Result3c.Data?.Length ?? 0}");
                    return false;
                }
                c1Response = c1Result3c.Data;
                ProdLog($"[C1] OK (3c): len={c1Response.Length}");
            }

            // INIT-020 / VB6 1.12 parity (frmMainW.frm:3151/3211): 3dr reads F1 (commonUl) always,
            // and C1 (MMS + BBU byte) for frversion==0 && ndev>=1. FATAL on failure (VB6 GoTo lberror).
            if (tdev == "3dr")
            {
                ProdLog("[F1] Sending F1 pre-read (3dr)...");
                var f1Cmd3dr = new SerialCommand { Payload = "F1", ExpectsAck = true, ExpectsData = true, AckTimeout = TimeSpan.FromSeconds(2), DataTimeout = TimeSpan.FromSeconds(10), MaxRetries = 1, CancellationToken = _cts?.Token ?? default };
                var f1Result3dr = await _pipeline.EnqueueCommandAsync(f1Cmd3dr);
                if (!f1Result3dr.Success || string.IsNullOrEmpty(f1Result3dr.Data) || f1Result3dr.Data.Length < 482)
                {
                    ProdLog($"[F1] FAILED (3dr) â€” Status={f1Result3dr.Status} DataLen={f1Result3dr.Data?.Length ?? 0}");
                    return false;
                }
                f1Response = f1Result3dr.Data;
                ProdLog($"[F1] OK (3dr): len={f1Response.Length}");
                if (device.FrVersion == 0 && ndev >= 1.0)
                {
                    ProdLog("[C1] Sending C1 pre-read (3dr ndev>=1)...");
                    var c1Cmd3dr = new SerialCommand { Payload = "C1", ExpectsAck = true, ExpectsData = true, AckTimeout = TimeSpan.FromSeconds(2), DataTimeout = TimeSpan.FromSeconds(10), MaxRetries = 1, CancellationToken = _cts?.Token ?? default };
                    var c1Result3dr = await _pipeline.EnqueueCommandAsync(c1Cmd3dr);
                    if (!c1Result3dr.Success || string.IsNullOrEmpty(c1Result3dr.Data) || c1Result3dr.Data.Length < 1624)
                    {
                        ProdLog($"[C1] FAILED (3dr) â€” Status={c1Result3dr.Status} DataLen={c1Result3dr.Data?.Length ?? 0}");
                        return false;
                    }
                    c1Response = c1Result3dr.Data;
                    ProdLog($"[C1] OK (3dr): len={c1Response.Length}");
                }
            }

            // Get production configuration for device
            var prodConfig = GetProductionConfig(tdev, ndev, nchannels, mode, clearROM, c1Response, device.FrVersion, f1Response);
    ...
    /// </remarks>
    private ProductionConfigData? GetProductionConfig(string tdev, double ndev, short nchannels, short mode, bool clearROM, string? c1Response = null, int frversion = 0, string? f1Response = null)
    {
        ...
        switch (tdev)
        {
            ...
            case "3dr":
                return GetProductionConfig_3DR(ndev, nchannels, mode, clearROM, frversion, f1Response, c1Response);
            ...
            case "5dm":
                return GetProductionConfig_5DM(ndev, nchannels, mode, clearROM, frversion, f1Response, c1Response);

            case "2dm" or "2dm1":
                return GetProductionConfig_2DM(tdev, nchannels, mode, clearROM);

            case "3c":
                return GetProductionConfig_3C(ndev, nchannels, mode, clearROM, c1Response);
    ...
    private ProductionConfigData GetProductionConfig_1C_V7(short nchannels, short mode, bool clearROM)
    {
        ...
        {
            Payload = "",
    ...
    private ProductionConfigData GetProductionConfig_1C_V8(short nchannels, short mode, bool clearROM)
    {
        ...
        config.Commands.Add(new ProductionCommand
        {
            Payload = "",
    ...
    /// </remarks>
    private ProductionConfigData GetProductionConfig_3DR(double ndev, short nchannels, short mode, bool clearROM, int frversion, string? f1Response, string? c1Response)
    {
        var config = new ProductionConfigData();

        bool commonUl = false;
        if (!string.IsNullOrEmpty(f1Response) && f1Response.Length >= 4
            && int.TryParse(f1Response.Substring(2, 2), System.Globalization.NumberStyles.HexNumber, null, out int f1Bits))
            commonUl = (f1Bits & 0x80) != 0; // VB Mid(factstr,3,2) & 0x80
        ...
        if (frversion > 0)
        {
            // VB6 3149-3176: frversion>0 -> C0 by commonUl + O0"01, no J.
            configPayload = commonUl ? "C0\" Input 1              External Input 2              External Input 3              Force RF OFF                  Annunciator 1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 " : "C0\" Input 1              External Input 2              External Input 3              Force RF OFF                  Annunciator 1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 ";
            oPayload = "O0\"01";
        }
        else if (ndev < 1)
        {
            // VB6 3185-3209
            configPayload = commonUl ? "" : "";
            jPayload = " Input 1              External Input 2              External Input 3              External Input 4              EC02EC02550214021402";
            oPayload = "O001";
        }
        else
        {
            // VB6 3210-3232: read C1, MMS, interpolate BBU byte (Mid(confstr,1576,1)). INIT-020.
            bool mms = false;
            char bbuByte = '0';
            if (!string.IsNullOrEmpty(c1Response) && c1Response.Length >= 1576)
            {
                bbuByte = c1Response[1575]; // VB Mid(confstr,1576,1)
                if (int.TryParse(c1Response.Substring(1574, 2), System.Globalization.NumberStyles.HexNumber, null, out int mmsBits))
                    mms = (mmsBits & 0x1) != 0; // VB Mid(confstr,1575,2) & 0x1
            }
            configPayload = (commonUl ? "" : "") + bbuByte + "000151800001518000015180000151800001518000015180";
            jPayload = mms ? " Input 1              External Input 2              External Input 3              External Input 4              EC02EC0255021402140201FFFFFF0F0102040800000000040000000000000000000000FFFF00000000000000000000FF0000F0FE00000151800000000000000000000000000000000151800001518000015180000151800001518000015180Annunciator 1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 " : " Input 1              External Input 2              External Input 3              External Input 4              EC02EC0255021402140201FFFFFF0F0102040800000000040000000000000000000000FFFF00000000000000000000FF0000F0FE00000151800000000000000000000000000000000151800001518000015180000151800001518000015180Annunciator 1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 ";
            oPayload = "O001";
        }

        config.Commands.Add(new ProductionCommand { Payload = configPayload, Description = "3dr Config (C command)", ExpectsAck = true, TimeoutSeconds = 10 });
        if (jPayload != null)
            config.Commands.Add(new ProductionCommand { Payload = jPayload, Description = "3dr Params (J command)", ExpectsAck = true, TimeoutSeconds = 10 });
        config.Commands.Add(new ProductionCommand { Payload = oPayload, Description = "Clear log (O command)", ExpectsAck = true, TimeoutSeconds = 5 });
        if (clearROM)
            config.Commands.Add(new ProductionCommand { Payload = "T0REMOTE FIPLEX                 ", Description = "Reset tag (T command)", ExpectsAck = true, TimeoutSeconds = 5 });
    ...
    /// </remarks>
    private ProductionConfigData GetProductionConfig_5DM(double ndev, short nchannels, short mode, bool clearROM, int frversion, string? f1Response, string? c1Response)
    {
        var config = new ProductionConfigData();

        // VB6 1.12 parity (frmMainW.frm:3309-3388): C0/J variant selected dynamically from the
        // device. commonUl from F1 (Mid(factstr,3,2) & 0x80); for ndev>=1, MMS from C1
        // (Mid(confstr,1719,2) & 0x1) and the BBU byte (Mid(confstr,1720,1)) is interpolated
        // into the C0. F1/C1 pre-read happens in SendProdConfigAsync. INIT-014.
        bool commonUl = false;
        if (!string.IsNullOrEmpty(f1Response) && f1Response.Length >= 4
            && int.TryParse(f1Response.Substring(2, 2), System.Globalization.NumberStyles.HexNumber, null, out int f1Bits))
        {
            commonUl = (f1Bits & 0x80) != 0;
        }
        ...
        if (frversion > 0)
        {
            // VB6 3310-3339: frversion>0 -> single C0 by commonUl, O00000, no J command.
            configPayload = commonUl ? @"C0"" Input 1              External Input 2              External Input 3              Force RF OFF                  Annunciator 1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 " : @"C0"" Input 1              External Input 2              External Input 3              Force RF OFF                  Annunciator 1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 ";
            oPayload = "O00000";
        }
        else if (ndev < 1)
        {
            // VB6 3348-3360: ndev<1 -> C0 + J by commonUl, O000.
            configPayload = commonUl ? @"" : @"";
            jPayload = commonUl ? @" Input 1              External Input 2              External Input 3              Force RF OFF/Remote Ext.Input EC02EC02EC02EC02EC02EC02EC02EC025502" : @" Input 1              External Input 2              External Input 3              Force RF OFF/Remote Ext.Input EC02EC02EC02EC02EC02EC02EC02EC025502";
            oPayload = "O000";
        }
        else
        {
            // VB6 3361-3387: ndev>=1 -> C0 = blob + BBU byte (Mid(confstr,1720,1)) + tail; J by MMS.
            bool mms = false;
            char bbuByte = '0';
            if (!string.IsNullOrEmpty(c1Response) && c1Response.Length >= 1720)
            {
                bbuByte = c1Response[1719]; // VB Mid(confstr,1720,1) = [1719] 0-indexed
                if (int.TryParse(c1Response.Substring(1718, 2), System.Globalization.NumberStyles.HexNumber, null, out int mmsBits))
                {
                    mms = (mmsBits & 0x1) != 0;
                }
            }
            configPayload = (commonUl ? @"" : @"") + bbuByte + (commonUl ? @"000151800001518000015180000151800001518000015180" : @"000151800001518000015180000151800001518000015180");
            jPayload = mms ? @" Input 1              External Input 2              External Input 3              Force RF OFF/Remote Ext.Input  1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 " : @" Input 1              External Input 2              External Input 3              Force RF OFF/Remote Ext.Input  1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 ";
            oPayload = "O000";
        }
    ...
    private ProductionConfigData GetProductionConfig_2DM(string tdev, short nchannels, short mode, bool clearROM)
    {
        ...
        config.Commands.Add(new ProductionCommand
        {
            Payload = "\tF001EC21EC210000000F-F001ED21ED210000000F-F001EE21EE210000000F-F001EF21EF210000000F-F001F021F0210000000F-F001F121F1210000000F-F001F221F2210000000F-F001F321F3210000000F",
    ...
    /// </remarks>
    private ProductionConfigData GetProductionConfig_3C(double ndev, short nchannels, short mode, bool clearROM, string? c1Response = null)
    {
        var config = new ProductionConfigData();
        ...
        if (ndev < 1)
        {
            // VB6 1.12 parity (frmMainW.frm:3447-3455): static C0/J for ndev<1.
            configPayload = "";
        ...
        {
            // VB6 1.12 parity (frmMainW.frm:3457-3469): read C1, MMS, interpolate BBU byte. INIT-019.
            bool mms = false;
            char bbuByte = '0';
            if (!string.IsNullOrEmpty(c1Response) && c1Response.Length >= 636)
            {
                bbuByte = c1Response[635]; // VB Mid(confstr,636,1)
                if (int.TryParse(c1Response.Substring(634, 2), System.Globalization.NumberStyles.HexNumber, null, out int mmsBits))
                    mms = (mmsBits & 0x1) != 0; // VB Mid(confstr,635,2) & 0x1
            }
            configPayload = "" + bbuByte + "";
            jPayload = mms ? " Input 1              External Input 2              External Input 3              Force RF OFF                  Annunciator 1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 " : " Input 1              External Input 2              External Input 3              Force RF OFF                  Annunciator 1                 Annunciator 2                 Annunciator 3                 Annunciator 4                 ";
        }
    ...
    private ProductionConfigData GetProductionConfig_3DM(string tdev, short nchannels, short mode, bool clearROM)
    {
        ...
        config.Commands.Add(new ProductionCommand
        {
            Payload = "\tF001EC21EC210000000F-F001ED21ED210000000F-F001EE21EE210000000F-F001EF21EF210000000F-F001F021F0210000000F-F001F121F1210000000F-F001F221F2210000000F-F001F321F3210000000F",
